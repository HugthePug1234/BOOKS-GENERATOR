...
New:git clone https://github.com/your-username/book-generator-web.git
cd book-generator-web


Existing:cd path/to/book-generator-web
...
Homepage: http://localhost:3000. See buttons: “Create Your First Character”, “Design Your Book”, etc.
Character Maker:
...
Terminal:
Run npm start. Check for:Accessing add_character route
...
Routes:
Confirm app.js has:app.post('/add_character', ...)
app.get('/get_characters', ...)
app.post('/set_details', ...)


Ensure index.html has:<button class="nav-button" onclick="showSection('characters-section'); fetchCharacters()">View Characters</button>
